---
title: "Análisis del universo de D&D"
...
```{r}
knitr::include_graphics("figures/spells_por_nivel.png")
```
...
```{r}
knitr::include_graphics("figures/spells_por_clase.png")
```
...
```{r}
knitr::include_graphics("figures/spells_heatmap.png")
```
...
```{r}
knitr::include_graphics("figures/monsters_por_cr.png")
```
...
```{r}
knitr::include_graphics("figures/monsters_inmunidad.png")
```
...
```{r}
knitr::include_graphics("figures/monsters_vulnerabilidad.png")
```
...
```{r}
knitr::include_graphics("figures/comparativo_spells_monsters.png")
```
...
En este análisis exploratorio del universo de Dungeons & Dragons 5e, se examinó cómo se distribuyen los hechizos y los monstruos a lo largo de sus niveles de poder, identificando patrones que pueden ayudar tanto a nuevos jugadores como a quienes buscan optimizar su experiencia de juego. La estructura de niveles muestra que los hechizos de bajo nivel son los más abundantes y accesibles, mientras que los de niveles altos se vuelven más escasos y especializados, lo que influye directamente en la progresión de las clases. Paralelamente, los monstruos presentan una concentración mayoritaria en niveles de amenaza bajos, lo que coincide con el diseño del juego orientado a facilitar la entrada al mundo de DnD.

Estas visualizaciones permiten comprender cómo se equilibra la relación entre desafíos y herramientas disponibles para los jugadores. Para alguien que quiera empezar a jugar o elegir su personaje, este análisis entrega una mirada concreta sobre qué clases poseen mayor versatilidad mágica, qué tipos de daño son más o menos efectivos en combate, y cómo escalan las amenazas a medida que avanza la campaña. Por último, este proyecto busca no solo describir datos, sino hacer más accesible la toma de decisiones dentro del juego, ayudando a nuevas personas a navegar un sistema que, aunque complejo, se vuelve mucho más intuitivo cuando se observa desde la visualización de datos.
